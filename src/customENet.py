...
"""
Code copied from
https://github.com/3zhang/Python-Lasso-ElasticNet-Ridge-Regression-with-Customized-Penalties/blob/main/custom_enet.py
that allows for different penalty for different coordinates of the beta coef
"""
